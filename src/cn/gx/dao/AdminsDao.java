...
public interface AdminsDao {
	...
	Admins getByUsernameAndPassword(@Param("username") String username, @Param("password") String password);
	...
	List<Admins> getList(@Param("begin") int begin, @Param("size") int size);
