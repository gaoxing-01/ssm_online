...
public interface GoodsDao {
	...
	long getTotalByType(@Param("typeid") int typeid);
	...
	List<Goods> getListByName(@Param("name") String name, @Param("begin") int begin, @Param("size") int size);
	...
	long getTotalByName(@Param("name") String name);
}